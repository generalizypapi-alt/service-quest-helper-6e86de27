    ...
    <footer className="bg-ink text-surface mt-24">
      ...
      <div className="border-b border-surface/10">
        <div className="max-w-7xl mx-auto px-6 py-14 flex flex-col md:flex-row md:items-center justify-between gap-8">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Link to="/contact" className="bg-surface/10 text-surface py-3 pl-6 pr-5 inline-flex items-center gap-2 rounded-full font-medium ring-1 ring-surface/15 hover:bg-surface/15 transition">
              Contact us
            </Link>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 grid gap-12 md:grid-cols-12">
        <div className="md:col-span-5 flex flex-col gap-6">
          <Link to="/" className="text-2xl font-semibold tracking-tight text-surface">OKIKE</Link>
          <p className="text-sm text-surface/60 max-w-sm leading-relaxed">
          ...
          <div className="flex items-center gap-2 pt-2">
            {[
              ...
              <a
                ...
                href={href}
                aria-label={label}
                className="size-9 inline-flex items-center justify-center rounded-full bg-surface/5 ring-1 ring-surface/10 hover:bg-brand hover:ring-brand transition"
              >
        ...
        <div className="md:col-span-2 flex flex-col gap-4">
          ...
          <Link to="/services" className="text-sm text-surface/70 hover:text-surface">Services</Link>
          <Link to="/book" className="text-sm text-surface/70 hover:text-surface">Start a project</Link>
          <Link to="/contact" className="text-sm text-surface/70 hover:text-surface">Contact</Link>
        </div>

        <div className="md:col-span-2 flex flex-col gap-4">
          <div className="text-xs font-semibold uppercase tracking-widest text-brand">Learn</div>
          <Link to="/learn" className="text-sm text-surface/70 hover:text-surface">Academy</Link>
          <Link to="/enroll" className="text-sm text-surface/70 hover:text-surface">Enroll</Link>
          <Link to="/about" className="text-sm text-surface/70 hover:text-surface">About</Link>
        </div>

        <div className="md:col-span-3 flex flex-col gap-4">
          <div className="text-xs font-semibold uppercase tracking-widest text-brand">Account</div>
          <Link to="/login" className="text-sm text-surface/70 hover:text-surface">Sign in</Link>
          <Link to="/signup" className="text-sm text-surface/70 hover:text-surface">Create account</Link>
          <Link to="/dashboard" className="text-sm text-surface/70 hover:text-surface">Dashboard</Link>
        </div>
      </div>

      <div className="border-t border-surface/10">
        <div className="max-w-7xl mx-auto px-6 py-6 flex flex-col md:flex-row justify-between items-center gap-3 text-xs text-surface/40">
